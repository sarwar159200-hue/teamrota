...
## Phase 29 availability hotfix

The workforce availability page now loads profiles and departments separately, falls back to the authenticated directory query when necessary, and displays a readable diagnostic instead of silently showing zero employees.


## Phase 31 — Enterprise Localization
Expanded centralized translations for English, Kurdish (Sorani), Arabic, and Urdu across all major modules and common UI states.
